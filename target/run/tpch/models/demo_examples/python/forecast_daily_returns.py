...
def ref(*args, **kwargs):
    refs = {"agg_daily_returned_orders": "sa_mark_wan.dbt_c_mwan.agg_daily_returned_orders"}
    key = '.'.join(args)
...
class this:
    ...
    def __repr__(self):
        return 'sa_mark_wan.dbt_c_mwan.forecast_daily_returns'
...
def materialize(session, df, target_relation):
    ...
    df.write.mode("overwrite").save_as_table('sa_mark_wan.dbt_c_mwan.forecast_daily_returns', create_temp_table=False)
