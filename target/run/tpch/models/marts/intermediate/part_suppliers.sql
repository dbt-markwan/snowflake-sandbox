  ...
  create or replace   view sa_mark_wan.dbt_c_mwan.part_suppliers
...
supplier as (
    ...
    select * from sa_mark_wan.dbt_c_mwan.stg_tpch_suppliers

),

part_supplier as (

    select * from sa_mark_wan.dbt_c_mwan.stg_tpch_part_suppliers
