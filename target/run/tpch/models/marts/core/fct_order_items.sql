        ...
        create or replace transient table sa_mark_wan.dbt_c_mwan.fct_order_items
         as
        (

with order_item as (
    
    select * from sa_mark_wan.dbt_c_mwan.order_items

),
part_supplier as (
    
    select * from sa_mark_wan.dbt_c_mwan.part_suppliers
